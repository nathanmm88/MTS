...
gulp.task('watch', ['browserSync', 'sass:dev'], function () {
    ...
    //gulp.watch('src/**', browserSync.reload); //if we want to reload the browser when changing any file
});
...
gulp.task('browserSync', function () {
    browserSync.init({
        open: 'external',
        host: 'simplyindian.mytakeawaysite.local',
        proxy: 'simplyindian.mytakeawaysite.local', // or project.dev/app/            
    })
})

gulp.src(['webroot/assets/scripts/**'])
        .pipe(jshint())
        .pipe(jshint.reporter('default'))
//  .pipe(jshint.reporter('fail'));//include if you want to fail if any found
